...
# which shows how to install the "microtrader" Java sample app in aws using Docker, ECS, CloudFormation, etc.
...
kill_microtrader_pids() {
   ...
   MICROTRADER_QUOTE_PSID=$(ps aux | grep 'microtrader-quote' | awk '{print $2}' | head -n 1 )
...
# fg  # fg=foreground
   # ./microtrader-setup.sh: line 274: fg: no job control
